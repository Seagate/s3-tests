...
def test_put_object_after_put_user_policy_deny():
    ...
    bucket_name = 'ceph-f5asg6gtbupsnn1klvrsanal-2'
    try:
        s3bucket = s3_client.create_bucket(Bucket=bucket_name)
        eq(s3bucket['ResponseMetadata']['HTTPStatusCode'],200)
        key = 'file1'
        bucket_policy = "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Deny\",\"Action\":[\"s3:PutObject\"],\"Resource\":\"arn:aws:s3:::ceph-f5asg6gtbupsnn1klvrsanal-2/*\"}]}"
        ...
        iam_client.delete_user_policy(UserName=s3_user_id,PolicyName=bucket_policy)
...
def test_put_object_after_put_user_policy_allow():
    ...
    bucket_name = 'ceph-b5csg6gtbupsnn1klvrsanal-8'
    try:
        s3bucket = s3_client.create_bucket(Bucket=bucket_name)
        eq(s3bucket['ResponseMetadata']['HTTPStatusCode'],200)
        bucket_policy = "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Action\":[\"s3:PutObject\"],\"Resource\":\"arn:aws:s3:::ceph-b5csg6gtbupsnn1klvrsanal-8/*\"}]}"
